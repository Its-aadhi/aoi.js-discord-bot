const { SI_SYMBOL } = require("aoi.js/src/utils/Constants.js");
...
module.exports = {
    ...
    /**
     * @param  {import('aoi.js/src/classes/AoiClient.js')} client
     */
    Client(client) {
        const data = {
    ...
    Timeout(d, name, duration, timeoutData) {
        ...
        require("aoi.js/src/events/Custom/timeout.js")(d, duration, timeoutData, false);
